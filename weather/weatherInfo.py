...
def make_url(weather_icon):
    ...
    for i in range(0,count):
        if weather_icon[i] == '1':
            icon_url.append("image/ic_small/ic_weather_sun.png")
        elif weather_icon[i] == '2':
            icon_url.append("image/ic_small/ic_weather_moon.png")
        elif weather_icon[i] == '3':
            icon_url.append("image/ic_small/ic_weather_cloud.png")
        elif weather_icon[i] == '4':
            icon_url.append("image/ic_small/ic_weather_rain.png")
        elif weather_icon[i] == '5':
            icon_url.append("image/ic_small/ic_weather_snow.png")
        elif weather_icon[i] == '6':
            icon_url.append("image/ic_small/ic_weather_fog.png")
        elif weather_icon[i] == '7':
            icon_url.append("image/ic_small/ic_weather_hail.png")
        elif weather_icon[i] == '8':
            icon_url.append("image/ic_small/ic_weather_mask.png")
        elif weather_icon[i] == '9':
            icon_url.append("image/ic_small/ic_weather_rain_snow.png")
