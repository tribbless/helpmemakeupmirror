...
class Frame_Eyeliner(QWidget):
    ...
    def __init__(self):
        ...
        self.pushButton_GoEyeshadowFrame.setGeometry(QtCore.QRect(60, 805, 168, 50))
        ...
        self.pushButton_GoEyeshadowFrame.clicked.connect(self.shifting)

        self.pushButton_GoBlusherFrame = QtWidgets.QPushButton(self)
        self.pushButton_GoBlusherFrame.setGeometry(QtCore.QRect(796, 805, 168, 50))
    ...
    def nextFrameSlot(self):
        ...
        # output = imutils.resize(output, width=750)
        cam = output
