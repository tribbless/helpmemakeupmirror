...
class Frame_Blusher(QWidget):
    ...
    def __init__(self):
        ...
        self.label_background_Manual.setText("blusher manual background image")
        ...
        self.pushButton_GoEyelinerFrame.setGeometry(QtCore.QRect(13, 567, 112, 30))
        ...
        self.pushButton_GoLipFrame.setGeometry(QtCore.QRect(437, 567, 112, 30))
