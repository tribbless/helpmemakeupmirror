...
class SubWindow_Weather(QDialog):
    def __init__(self):
        super().__init__()
        self.initUI()
    ...
    def initUI(self):
        ...
        self.label_title.setGeometry(QtCore.QRect(40, 0, 120, 90))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        self.label_title.setFont(font)
        self.label_title.setText("TODAY")
        self.label_title.setStyleSheet('background-color:transparent; color:white;')

        self.label_subtitle = QtWidgets.QLabel(self)
        self.label_subtitle.setGeometry(QtCore.QRect(170, 10, 300, 80))
        font = QtGui.QFont()
        ...
        self.label_TempThree.setText("18℃")
        ...
        self.label_TempFour.setText("19℃")
        ...
        self.label_TempSeven.setText("22℃")
        ...
        self.label_TempEight.setText("20℃")
