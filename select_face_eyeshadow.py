...
class Color(QWidget):
    def __init__(self):
        ...
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton_ColorNine.setMinimumSize(172, 150)
        self.pushButton_ColorNine.setText("ColorNine")
        self.pushButton_ColorNine.setFont(font)
        self.pushButton_ColorNine.setStyleSheet('background-color:white;')
...
class Select_face_Eyeshadow(QWidget):
    ...
    def Apply_ResetColor(self):
        ...
        self.color.pushButton_ColorNine.setStyleSheet('background-color:white;')
        self.slider.hide()
        self.label_slider.hide()
    ...
    def Apply_ColorNine(self):
        ...
        print(self.stk_w2.width())
        self.color.pushButton_ColorNine.setStyleSheet('background-color:black;color:white;')
        self.color.pushButton_ResetColor.setStyleSheet('background-color:white;')
        self.color.pushButton_ColorOne.setStyleSheet('background-color:white;')
        self.color.pushButton_ColorTwo.setStyleSheet('background-color:white;')
        self.color.pushButton_ColorThree.setStyleSheet('background-color:white;')
    ...
    def goToColor(self):
        self.stk_w2.setMaximumWidth(1810)
